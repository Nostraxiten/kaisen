...
pub const CVE_DB: &[CveEntry] = &[
    ...
    CveEntry {
        ...
        summary: "Vulnerabilidad de omisión de restricciones de la API Moniker (Moniker Link) que permite la ejecución de código remoto sin interacción (Zero-click) al procesar un enlace malicioso.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2024-21413",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "GlobalProtect",
        cpe: "cpe:2.3:a:paloaltonetworks:pan-os",
        cve: "CVE-2024-3400",
        cvss: 10.0,
        severity: Severity::Critical,
        title: "PAN-OS GlobalProtect Command Injection",
        summary: "Inyección de comandos en la pasarela GlobalProtect de PAN-OS que permite ejecución de código remoto como root sin autenticación.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2024-3400",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "ScreenConnect",
        cpe: "cpe:2.3:a:connectwise:screenconnect",
        cve: "CVE-2024-1709",
        cvss: 10.0,
        severity: Severity::Critical,
        title: "ConnectWise ScreenConnect Auth Bypass",
        summary: "Fallo de validación en SetupWizard.aspx que permite la creación de un usuario administrador en instancias expuestas. Confirmar parche.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2024-1709",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "TeamCity",
        cpe: "cpe:2.3:a:jetbrains:teamcity",
        cve: "CVE-2024-27198",
        cvss: 9.8,
        severity: Severity::Critical,
        title: "JetBrains TeamCity Auth Bypass",
        summary: "Omisión de autenticación en TeamCity Server anterior a 2023.11.4 que permite a un atacante no autenticado tomar control del servidor y ejecutar código.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2024-27198",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "ActiveMQ",
        cpe: "cpe:2.3:a:apache:activemq",
        cve: "CVE-2023-46604",
        cvss: 10.0,
        severity: Severity::Critical,
        title: "Apache ActiveMQ RCE (OpenWire)",
        summary: "Ejecución remota de código en el protocolo OpenWire de ActiveMQ (puerto 61616 por defecto) mediante clases serializadas maliciosas (Throwable class).",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2023-46604",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "NetScaler",
        cpe: "cpe:2.3:a:citrix:netscaler_adc",
        cve: "CVE-2023-4966",
        cvss: 9.4,
        severity: Severity::Critical,
        title: "Citrix Bleed (NetScaler Memory Leak)",
        summary: "Fuga de memoria sin autenticación que expone tokens de sesión activos de NetScaler ADC/Gateway, permitiendo secuestro de sesión y acceso a la red.",
    ...
    CveEntry {
        ...
        summary: "Inyección de código sin autenticación en NetScaler ADC/Gateway cuando está configurado como Gateway o servidor AAA.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2023-3519",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Confluence",
        cpe: "cpe:2.3:a:atlassian:confluence",
        cve: "CVE-2023-22527",
        cvss: 10.0,
        severity: Severity::Critical,
        title: "Atlassian Confluence OGNL RCE",
        summary: "Inyección OGNL en versiones antiguas de Confluence Data Center y Server (8.0.x, 8.1.x, 8.2.x, 8.3.x, 8.4.x, 8.5.0-8.5.3) que permite ejecución de código remoto.",
    ...
    CveEntry {
        ...
        cvss: 9.8,
        severity: Severity::Critical,
        title: "Atlassian Confluence OGNL Injection (2022)",
        summary: "Vulnerabilidad crítica de inyección OGNL sin autenticación en Confluence Server y Data Center anterior a 7.18.1.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2022-26134",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "ManageEngine",
        cpe: "cpe:2.3:a:zohocorp:manageengine",
        cve: "CVE-2022-47966",
        cvss: 9.8,
        severity: Severity::Critical,
        title: "Zoho ManageEngine SAML RCE",
        summary: "Ejecución de código remoto pre-autenticación en múltiples productos ManageEngine debido al uso de Apache Santuario vulnerable para SSO SAML.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2022-47966",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Microsoft Exchange",
        cpe: "cpe:2.3:a:microsoft:exchange_server",
        cve: "CVE-2022-41040",
        cvss: 8.8,
        severity: Severity::High,
        title: "Exchange ProxyNotShell (SSRF)",
        summary: "Vulnerabilidad Server-Side Request Forgery en Microsoft Exchange 2013, 2016 y 2019 que encadenada con CVE-2022-41082 permite RCE. (Requiere confirmación).",
    ...
    CveEntry {
        ...
        cvss: 9.8,
        severity: Severity::Critical,
        title: "Exchange ProxyLogon (SSRF)",
        summary: "Fallo SSRF en Exchange que permite evadir la autenticación y, encadenado, escribir archivos (RCE). Explotado masivamente en 2021.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2021-26855",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Spring",
        cpe: "cpe:2.3:a:vmware:spring_framework",
        cve: "CVE-2022-22965",
        cvss: 9.8,
        severity: Severity::Critical,
        title: "Spring4Shell (RCE in Spring Core)",
        summary: "Vulnerabilidad en Spring Framework anterior a 5.3.18 / 5.2.20 que permite ejecución de código remoto vía data binding bajo ciertas configuraciones.",
    ...
    CveEntry {
        ...
        summary: "La famosísima vulnerabilidad en Apache Log4j2 (2.0 a 2.14.1) que evalúa y resuelve cadenas JNDI inyectadas, dando RCE remoto inmediato. (Suele ser detectado indirectamente).",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2021-44228",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "vCenter",
        cpe: "cpe:2.3:a:vmware:vcenter_server",
        cve: "CVE-2021-21985",
        cvss: 9.8,
        severity: Severity::Critical,
        title: "VMware vCenter Server RCE",
        summary: "Fallo de inyección de comandos en el plugin vSphere Client (HTML5) de vCenter debido a validación insuficiente, explotable por atacante no autenticado (puerto 443).",
    ...
    CveEntry {
        ...
        cvss: 9.8,
        severity: Severity::Critical,
        title: "VMware vCenter Heap Overflow RCE",
        summary: "Desbordamiento de montón en el protocolo DCERPC del servidor vCenter que permite a un atacante con acceso a red ejecutar código remoto.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2024-38812",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Netlogon",
        cpe: "cpe:2.3:a:microsoft:windows_server",
        cve: "CVE-2020-1472",
        cvss: 10.0,
        severity: Severity::Critical,
        title: "Zerologon (Netlogon Auth Bypass)",
        summary: "Vulnerabilidad en Netlogon (MS-NRPC) que permite a un atacante no autenticado falsificar el inicio de sesión y comprometer todo el Active Directory.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2020-1472",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Pulse Secure",
        cpe: "cpe:2.3:a:ivanti:pulse_connect_secure",
        cve: "CVE-2019-11510",
        cvss: 10.0,
        severity: Severity::Critical,
        title: "Pulse Secure VPN Path Traversal",
        summary: "Fallo crítico en Pulse Connect Secure (PCS) 8.2/8.3/9.0 que permite a usuarios no autenticados leer archivos locales (como contraseñas, claves, sesiones) mediante URIs manipuladas.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2019-11510",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Citrix Gateway",
        cpe: "cpe:2.3:a:citrix:application_delivery_controller",
        cve: "CVE-2019-19781",
        cvss: 9.8,
        severity: Severity::Critical,
        title: "Citrix ADC/Gateway Path Traversal RCE",
        summary: "Vulnerabilidad de Path Traversal en Citrix ADC/Gateway que permite la ejecución de código remoto (RCE) sin autenticación.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2019-19781",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "FortiOS",
        cpe: "cpe:2.3:o:fortinet:fortios",
        cve: "CVE-2018-13379",
        cvss: 9.8,
        severity: Severity::Critical,
        title: "FortiOS SSL VPN Path Traversal",
        summary: "Path Traversal en el portal web SSL VPN de FortiOS que permite a atacantes descargar archivos del sistema de forma no autenticada (ej. sslvpn_websession).",
    ...
    CveEntry {
        ...
        cvss: 9.6,
        severity: Severity::Critical,
        title: "FortiOS/FortiProxy WebMgmt Auth Bypass",
        summary: "Vulnerabilidad en la interfaz de gestión web que permite a un atacante remoto no autenticado obtener acceso de superadministrador vía peticiones maliciosas.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2024-55591",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Connect Secure",
        cpe: "cpe:2.3:a:ivanti:connect_secure",
        cve: "CVE-2025-0282",
        cvss: 9.0,
        severity: Severity::Critical,
        title: "Ivanti Connect Secure Stack Overflow",
        summary: "Desbordamiento de pila pre-autenticación explotado in-the-wild a inicios de 2025. Permite RCE.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2025-0282",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "Jenkins",
        cpe: "cpe:2.3:a:jenkins:jenkins",
        cve: "CVE-2024-23897",
        cvss: 9.8,
        severity: Severity::Critical,
        title: "Jenkins CLI Arbitrary File Read",
        summary: "Fallo en el parser args4j del CLI de Jenkins que expone la lectura de archivos locales. Puede llevar a RCE (ejecución remota).",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2024-23897",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "GitLab",
        cpe: "cpe:2.3:a:gitlab:gitlab",
        cve: "CVE-2023-7028",
        cvss: 10.0,
        severity: Severity::Critical,
        title: "GitLab Password Reset Account Takeover",
        summary: "Debilidad en el flujo de recuperación de contraseña de GitLab (16.1 - 16.7.1) que permite inyectar un correo adicional y secuestrar cualquier cuenta (incluyendo admins).",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2023-7028",
        affected: |_v| true,
    },
    CveEntry {
        match_product: "GitLab",
        ...
        summary: "Vulnerabilidad en la validación de imágenes subidas a GitLab que usa ExifTool de forma insegura, resultando en RCE no autenticado.",
    ...
    CveEntry {
        ...
        summary: "Escape del sandbox de Lua en paquetes Debian/Ubuntu de Redis, dando lugar a ejecución de código remota si el entorno Lua es accesible (ej. puerto expuesto y sin password/vulnerable).",
    ...
    CveEntry {
        ...
        cvss: 7.5,
        severity: Severity::High,
        title: "Nginx URI Processing Security Bypass",
        summary: "Un espacio sin escapar (' ') seguido de un null byte en el URI engaña a las comprobaciones de nginx anterior a 1.4.4 y 1.5.7, saltando directivas de control de acceso y ejecutando scripts.",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2013-4547",
        affected: |v| {
            !v.is_zero() && ((v >= Version::parse("0.8.41") && v < Version::parse("1.4.4")) || (v >= Version::parse("1.5.0") && v < Version::parse("1.5.7")))
        },
    },
    CveEntry {
        match_product: "nginx",
        ...
        cvss: 7.5,
        severity: Severity::High,
        title: "Nginx Integer Overflow (Range Filter)",
        summary: "Nginx anterior a 1.13.3 y 1.12.1 expone partes de memoria (posibles credenciales/claves) por culpa de un desbordamiento entero en los offsets grandes al usar peticiones de Rango (Range requests).",
        reference: "https://nvd.nist.gov/vuln/detail/CVE-2017-7529",
        affected: |v| {
            !v.is_zero() && ((v >= Version::parse("0.5.6") && v < Version::parse("1.12.1")) || (v >= Version::parse("1.13.0") && v < Version::parse("1.13.3")))
        },
    },
];
